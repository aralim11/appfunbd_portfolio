        ...
        <div class="row grid" data-aos="fade-up" data-aos-duration="2000">
            ...
            <div class="col-lg-4 col-md-6 grid-item {{$details['id']}}">
                <div class="box">
                    ...
                    <div class="icon-box"><a href="#" data-bs-toggle="modal" data-bs-target="#{{$project['id']}}"><i
                                class="bi bi-plus-lg"></i></a></div>

                    <!-- Modal -->
                    <div class="modal fade" id="{{$project['id']}}" tabindex="-1" aria-labelledby="{{$project['id']}}"
                        aria-hidden="true">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="row item-content">
                                        <div class="col-xl-12">
                                            <img src="{{ asset($project['img']['main_img']) }}" alt="portfolio image">
                                        </div>
                                        <div class="col-xl-8">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="meta-wrapper">
                                                <ul class="item-meta">
                                                    ...
                                                    <li>Client: <span
                                                            class="meta-value">{{$project['integrations']}}</span></li>
